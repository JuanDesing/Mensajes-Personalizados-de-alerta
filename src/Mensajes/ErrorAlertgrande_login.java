 ...
 * @author Rojeru San
 */
public class ErrorAlertgrande_login extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public ErrorAlertgrande_login(JFrame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ErrorAlertgrande_login.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ErrorAlertgrande_login dialog = new ErrorAlertgrande_login(new javax.swing.JFrame(), true);
